...
/// Track names are manually specified by the user when creating configurations.
/// </summary>
public class ConfigManager
{
    ...
    public ConfigManager(string vehicleName = "default", string trackName = "default")
    {
    ...
    public ShiftPointConfig LoadConfig()
    {
        ...
        try
        {
            if (File.Exists(configFilePath))
            {
                ...
                var config = JsonSerializer.Deserialize<ShiftPointConfig>(json);
        ...
        catch (Exception ex)
        {
            ...
            return ShiftPointConfig.CreateDefault();
        }
    }

    // Saves config to file based on current mode
    public bool SaveConfig(ShiftPointConfig config)
    {
        try
        {
            string configFilePath = GetConfigPath(_currentVehicleName, CurrentMode);
    ...
    public bool SaveAutoConfig(ShiftPointConfig config)
    {
        try
        {
