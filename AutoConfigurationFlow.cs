...
public static class AutoConfigurationFlow
{
    ...
    private static bool AnalyzeAndSaveData(OptimalShift analyzer, ConfigManager configManager, int maxGear)
    {
        Console.Clear();
        Console.WriteLine("=".PadRight(80, '='));
        ...
        if (report.OverallSuccess)
        {
            ...
            {
                var autoConfig = ShiftPointConfig.FromOptimalConfig(optimalConfig);
                ...
                try
                {
                    ...
                    string graphPath = PowerCurveGraph.GenerateGraph(
                        autoConfig,
