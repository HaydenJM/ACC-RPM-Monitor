...
public static class ConfigUI
{
    ...
    public static void ShowHelpMenu()
    {
        while (true)
        {
            ...
            Console.WriteLine("    - Physics-based intelligent shift point detection");
            Console.WriteLine("    - Collect data during straight-line acceleration (Monza/Paul Ricard recommended)");
            Console.WriteLine("    - Press F1 to start data collection");
            Console.WriteLine("    - IMPORTANT: Do 3-4 full acceleration runs in straight lines");
            Console.WriteLine("      • Full throttle (85%+) through each gear");
            Console.WriteLine("      • Let each gear reach AS HIGH RPM AS POSSIBLE (near redline)");
            Console.WriteLine("      • System needs to see FULL RPM RANGE to calculate optimal shift points");
            Console.WriteLine("      • Filters out corners automatically (only collects straight-line data)");
            Console.WriteLine("    - Press F1 to stop when finished");
            Console.WriteLine("    - Review detailed report showing physics-based optimal shift points");
            Console.WriteLine("    - Power curve graphs automatically generated");
            Console.WriteLine();
            Console.WriteLine("[2] CREATE/EDIT MANUAL CONFIGURATION");
            ...
            Console.WriteLine("      • Adaptive: Uses physics-based analysis to continuously optimize shift points");
            Console.WriteLine("        - Applies intelligent filters (straight-line only, throttle 85%+, RPM rising)");
            Console.WriteLine("        - Updates every 15 seconds based on acceleration curve analysis");
            Console.WriteLine("        - Pitch-based audio feedback");
            Console.WriteLine("      • Performance Learning: Combines physics with lap time correlation");
            Console.WriteLine("        - Starts with physics-based optimal shift points");
            Console.WriteLine("        - Validates with actual lap performance (requires 2+ valid laps)");
            Console.WriteLine("        - Confidence scoring increases with more data");
            Console.WriteLine();
            ...
            Console.WriteLine("  Two audio feedback strategies available:");
            Console.WriteLine();
            Console.WriteLine("  1. PERFORMANCE LEARNING (real-time pitch guidance during shift approach):");
            Console.WriteLine("     - Plays tones as you approach shift point");
            ...
            Console.WriteLine();
            Console.WriteLine("  2. FEEDBACK-BASED OPTIMIZATION (post-shift correction feedback):");
            Console.WriteLine("     - SILENT during driving - only provides feedback AFTER you shift");
            Console.WriteLine("     - High pitch (950 Hz): You shifted too EARLY - shift later next time");
            Console.WriteLine("     - NO SOUND: Perfect shift! (within ±175 RPM of optimal)");
            Console.WriteLine("     - Low pitch (400 Hz): You shifted too LATE - shift earlier next time");
            Console.WriteLine("     - Feedback plays 200ms after shift to avoid confusion with next gear");
            Console.WriteLine();
            Console.WriteLine("  AUDIO PROFILES (both modes):");
            Console.WriteLine("    Normal - Responsive tones for immediate feedback (practice/qualifying)");
            Console.WriteLine("    Endurance - Low-fatigue tones for extended sessions (long races)");
            Console.WriteLine();
            ...
            Console.WriteLine("  - RPM must be RISING (100+ RPM/sec) - system filters out corners automatically");
            Console.WriteLine("  - Best results: Do straight-line acceleration runs to capture full RPM range");
            Console.WriteLine();
