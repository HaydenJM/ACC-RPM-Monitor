...
public static class PowerCurveGraph
{
    /// <summary>
    ...
    public static string GenerateGraph(ShiftPointConfig config, string vehicleName, string outputDir, Dictionary<int, int>? userActualShiftPoints = null)
    {
